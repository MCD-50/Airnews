...
public class GoogleNews extends AsyncTask<String, Void, String> {
    private AsyncResponse delegate = null;
    public GoogleNews(AsyncResponse delegate){
    ...
    protected String doInBackground(String... params) {
        ...
        if (html != null) {
            content = html.body().getElementById("article-body").getElementsByAttributeValue("itemprop","articleBody");
